...
impl Plugin for MayorPlugin {
    fn build(&self, app: &mut App) {
        app.add_system_set(SystemSet::on_enter(AppState::TownMayor).with_system(town_init))
            .add_system_set(SystemSet::on_update(AppState::TownMayor).with_system(town_update));
    }
}
